...
from utils import to_devices,plot_accu
...
save_path = "./img/a1_false_positive_rate.png"
...
save_path = "./img/a1_false_negative_rate.png"
...
save_path = "./img/a1_HLISA_Detection_Rate.png"
